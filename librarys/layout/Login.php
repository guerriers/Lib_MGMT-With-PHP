...
<body class="body-login">
    ...
    <div class="container">
        ...
        <form name="form" class=" form-signin" method="post" action="Checklogin.php">
            <!-- <img class="mb-4" src="/docs/5.0/assets/brand/bootstrap-logo.svg" alt="" width="72" height="57"> -->
            <h1 class="h1-text">Login</h1>
            <h2 class="h2-text">Member</h2>
            ...
            <br>
            <br>
            <a class="mt-5 mb-3 text-danger" href="Loginlib.php">Login For Librarian</a>
