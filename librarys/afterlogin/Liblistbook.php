                ...
                <div class="col-md-12 ">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='Editbook.php?b_id_b=" . $row['b_id_b'] . "' class='btn btn-warning'><i class='fas fa-user-edit'></i></a></td>";
                            echo "<td><a href='Deletebook.php?b_id_b=" . $row['b_id_b'] . "' class='btn btn-danger'><i class='fas fa-trash'></i></a></td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "ไม่พบข้อมูล";
